class ShadowsocksGoLocal < Formula
    ...
    if MacOS.prefer_64_bit?
        url "https://github.com/shadowsocks/shadowsocks-go/releases/download/1.1.5/shadowsocks-local-linux64-1.1.5.gz"
        sha256 "3d7c6a0af87e6d214faff93aa46ae989d5534b6b9f01474fd3538c9a2559dd64"
    else
        url "https://github.com/shadowsocks/shadowsocks-go/releases/download/1.1.5/shadowsocks-local-linux32-1.1.5.gz"
