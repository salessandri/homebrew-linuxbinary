class Unetbootin < Formula
    ...
    if MacOS.prefer_64_bit?
        url "https://launchpad.net/unetbootin/trunk/625/+download/unetbootin-linux64-625.bin"
        sha256 "845e653572dd8589ba5a76fcc1ea8c8c8d238e0e2a32db6a0c56b1f0b6620175"
    else
        url "https://launchpad.net/unetbootin/trunk/625/+download/unetbootin-linux-625.bin"
    ...
    def install
        ...
        if MacOS.prefer_64_bit?
            bin.install({"#{prefix}/unetbootin-linux64-625.bin" => "unetbootin"})
        else
            bin.install({"#{prefix}/unetbootin-linux-625.bin" => "unetbootin"})
        end
    end
end
